...
<Card>
  <PinCodeProtectedContent>
    ...
    <Unlocked>
      - ოთხშაბათი: https://youtu.be/vdbwwUj6MT8 - source code:
      [Stackblitz](https://stackblitz.com/edit/js-twfhnf?file=index.js) -
      პარასკევი: https://youtu.be/Vl1REMfoQhw - source code:
      [Stackblitz](https://stackblitz.com/edit/js-zxxmhz?file=index.js)
    </Unlocked>
  </PinCodeProtectedContent>
</Card>
