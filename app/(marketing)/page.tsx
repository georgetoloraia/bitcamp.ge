      ...
      <section className="space-y-6 pb-8 pt-6 md:pb-12 md:pt-10 lg:py-32">
        <div className="container flex max-w-[64rem] flex-col items-center gap-4 text-center">
          ...
          <p className="max-w-[42rem] leading-normal text-muted-foreground sm:text-xl sm:leading-8">
            BitCamp - ის საიტი განახლების რეჟიმშია.
            ყველა სასწავლო პროგრამა დაიწყება ერთდროულად, სექტემბრის ბოლომდე. 
            რეგისტრაციები გაიხსნება 18 სექტემბრამდე.
          </p>
        </div>
      </section>
    );
        ...
        <div className="mx-auto grid justify-center gap-4 sm:grid-cols-2 md:max-w-[64rem] md:grid-cols-3">
          {subjects.map((subject) => {
            ...
            return (
              <div className="relative overflow-hidden rounded-lg border bg-background p-2">
                <div className="flex h-[400px] flex-col justify-between rounded-md p-6">
                  <Icon className="h-12" style="width: 100px;" />
                  <div className="space-y-2 ">
                    <h3 className="font-bold">
                      {subject.name}{" "}
                      <Badge variant="outline" className="mr-2">
                    ...
                    <div className="py-4">
                      {subject.technologies.map((technology) => (
                        <Badge variant="secondary" className="mr-2">
                          {technology}
                        </Badge>
                      ))}
